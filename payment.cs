    ...
    public partial class payment : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                dbc.ProductTable = dbc.DS.Tables["payment"];//*
                DataRow newRow = dbc.ProductTable.NewRow();
                newRow["s_number"] = textBox1.Text;
                newRow["pay_number"] = textBox4.Text;
                newRow["pay_price"] = textBox2.Text;
                newRow["pay_way"] = textBox3.Text;
                newRow["pay_date"] = textBox5.Text;
                newRow["m_number"] = textBox6.Text;

                dbc.ProductTable.Rows.Add(newRow);
                dbc.DBAdapter.Update(dbc.DS, "payment");
                dbc.DS.AcceptChanges();//*
                                       //ClearTextBoxes();  //*
                DBGrid.DataSource = dbc.DS.Tables["payment"].DefaultView;    // E_info NIKE 쪽으로 이동해야하는데 그 부분 추가적 수정해야함
            }
            ...
            num[a].PAY_NUMBER = textBox4.Text;
            num[a].PAY_PRICE = textBox2.Text;
            num[a].PAY_WAY = textBox3.Text;
            num[a].PAY_DATE = textBox5.Text;
            num[a].M_NUMBER = textBox6.Text;
            a++;
            this.Close();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string commandString = "select s_number,  pay_number,  pay_price, pay_way, pay_date, m_number from payment"; //,뭔지 확인해야함 Register R where P.ID=R.ID ";
